...
2. Accept the proposal with probability $p_\text{acc}(a=1|j \leftarrow k)$ and move to state $j$. Otherwise reject and stay in state $k$.
...
https://leftasexercise.com/2018/03/12/the-ising-model-and-gibbs-sampling/
