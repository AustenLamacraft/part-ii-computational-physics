...
For details about where the interpreter looks to find modules you try and import are in the [documentation](https://docs.python.org/3/tutorial/modules.html).
